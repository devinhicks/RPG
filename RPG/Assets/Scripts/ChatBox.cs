...
public class ChatBox : MonoBehaviourPun
{
    ...
    public void OnChatInputSend()
    {
        ...
        {
            photonView.RPC("Log", RpcTarget.All, PhotonNetwork.LocalPlayer.NickName,
                chatInput.text);
            chatInput.text = " ";
        }
    ...
    void Log (string playerName, string message)
    {
        ...
        chatLogText.rectTransform.sizeDelta = new Vector2(chatLogText.rectTransform.sizeDelta.x,
            chatLogText.mesh.bounds.size.y + 20);
    }
